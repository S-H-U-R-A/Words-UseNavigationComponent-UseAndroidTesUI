...
class WordAdapter(
    ...
    //Se crea una lista para almacenar las cadenas ya filtradas
    private val filteredWords: List<String>

    init {
        // se obtienen la lista de palabras de  res/values/arrays.xml y se convierten a lista
    ...
    override fun onBindViewHolder(holder: WordViewHolder, position: Int) {
        ...
        holder.button.setOnClickListener {
            ...
            //INTENT PARA BUSCAR EN LA WEB LA PALABRA
